...
// THIS FILE CREATES IN devel/lib a library called "libforce_joint.so" that it is necessary to copy to /opt/ros/melodic/lib/ (with sudo)
// from https://answers.ros.org/question/233059/gazebo-set-joint-angles-by-ros/
    ...
    public:
        ...
        void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
        {
            ...
            for(physics::Joint_V::iterator jit=jointVector.begin(); jit!=jointVector.end(); ++jit)
            {
                ...
                //if not, ignore joint
                if((*jit)->GetType() != 576 || (*jit)->GetName() == "wheel_left_joint" || (*jit)->GetName() == "wheel_right_joint")
                    continue;
